...
Public Class frmGarbageCatSetup
    Dim myDT As New DataTable
    Dim myBindingSource As New BindingSource
    Dim sql As String = "Select * From GarbageCatMaster"
    ...
    Private Sub frmUserSetup_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tbID.DataBindings.Add("Text", myBindingSource, "GarbageCatId")
        tbName.DataBindings.Add("Text", myBindingSource, "GarbageCatName")
    ...
    Private Function tSearchInfo() As Boolean
        ...
        Try
            ...
            FindID.SearchUnit = "  GarbageCatId, GarbageCatName"



            FindID.bindSQL = "SELECT     GarbageCatId AS 編號, GarbageCatName AS 垃圾分類1名稱, on_show AS 顯示, seq_no AS 排序, sys_date AS 修改日期, mod_user AS 經手人" & _
                            " FROM         GarbageCatMaster "


            tbID.Text = FindID.SearchID

            Dim sql As String = "SELECT     GarbageCatId, GarbageCatName, on_show, sys_date, seq_no, mod_user FROM         GarbageCatMaster " & _
                            "  where GarbageCatId='" + tbID.Text + "'"
            ...
            If dt.Rows.Count <> 0 Then
                ...
                tbID.Text = dt.Rows(0)("GarbageCatId").ToString()
                tbName.Text = dt.Rows(0)("GarbageCatName").ToString()
        ...
        If MessageBox.Show("是否刪除?刪除的檔案不可被回復!", "警告", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                ...
                Else
                    ...
                    Dim sqla As String = "Delete from GarbageCatMaster where GarbageCatId= '" & id & "'"
    ...
    Private Sub tbSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        ...
        Dim id As String = Me.tbID.Text
        Dim GarbageCatName As String = Me.tbName.Text
        ...
        If id = String.Empty Then
            ...
            sql = "Insert into GarbageCatMaster     (GarbageCatName, on_show, seq_no, Mod_User) " & _
                " VALUES ('" & _
                GarbageCatName & "','" & _
                on_show & "','" & _
                seq_no & "','" & _
        ...
        Else
            ...
            Dim sql As String = "Update GarbageCatMaster set GarbageCatName = '" & GarbageCatName & _
                                                                "',on_show='" & on_show & _
                                "',seq_no='" & seq_no & _
                                "',Mod_User='" & MainScript.UserName & _
                                "' where GarbageCatId='" & id & "'"
