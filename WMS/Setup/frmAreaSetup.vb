...
Public Class frmAreaSetup
    Dim myDT As New DataTable
    Dim myBindingSource As New BindingSource
    Dim sql As String = " SELECT          DistrictMaster.DistrictName, AreaMaster.AreaId, AreaMaster.AreaName, AreaMaster.DistrictId, AreaMaster.on_show,  " & _
...
"                             DistrictMaster ON AreaMaster.DistrictId = DistrictMaster.DistrictId "
    ...
    Private Sub frmUserSetup_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tbID.DataBindings.Add("Text", myBindingSource, "AreaId")
        tbName.DataBindings.Add("Text", myBindingSource, "AreaName")
    ...
    Private Function tSearchInfo() As Boolean
        ...
        Try
            ...
            FindID.SearchUnit = "  AreaId, AreaName "



            FindID.bindSQL = "SELECT     AreaId AS 編號, AreaName AS 國家名稱,on_show AS 顯示, seq_no AS 排序, sys_date AS 修改日期, ModUser AS 經手人" & _
                            " FROM         AreaMaster "
...
"                             AreaMaster.sys_date, AreaMaster.seq_no, AreaMaster.ModUser " & _
" FROM              AreaMaster LEFT OUTER JOIN " & _
"                             DistrictMaster ON AreaMaster.DistrictId = DistrictMaster.DistrictId " & _
                                        "  where AreaId='" + tbID.Text + "'"
            ...
            If dt.Rows.Count <> 0 Then
                ...
                tbID.Text = dt.Rows(0)("AreaId").ToString()
                tbName.Text = dt.Rows(0)("AreaName").ToString()
                cbDistrict.Text = dt.Rows(0)("DistrictName").ToString()
    ...
    Private Sub btDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btDel.Click
        If MessageBox.Show("是否刪除?刪除的檔案不可被回復!", "警告", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            Else
                ...
                Dim sql As String = "Delete from AreaMaster where AreaId= '" & id & "'"
    ...
    Private Sub tbSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Dim id As String = Me.tbID.Text
        Dim AreaName As String = Me.tbName.Text
        ...
        If id = String.Empty Then
            ...
            sql = "Insert into AreaMaster     (AreaName, DistrictId, on_show, seq_no, ModUser) " & _
                " VALUES ('" & _
                AreaName & "','" & _
                DistrictId & "','" & _
                      on_show & "','" & _
        ...
        Else
            ...
            Dim sql As String = "Update AreaMaster set AreaName = '" & AreaName & _
                                                              "',on_show='" & on_show & _
                                "',seq_no='" & seq_no & _
    ...
    Private Sub btPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btPrint.Click
        ...
        Using a As New frmReportViewer
            ...
            Dim sql As String = " SELECT      AreaMaster.AreaId, AreaMaster.AreaName, AreaMaster.DistrictId, AreaMaster.on_show, AreaMaster.sys_date, AreaMaster.seq_no, AreaMaster.ModUser,  " & _
"                       DistrictMaster.DistrictName " & _
" FROM         AreaMaster LEFT OUTER JOIN " & _
"                       DistrictMaster ON AreaMaster.DistrictId = DistrictMaster.DistrictId "
